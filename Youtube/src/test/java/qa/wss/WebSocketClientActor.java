...
/**
 * This class represents a web socket client and is implemented as an actor to
 * run as a separated process with its own message box.
 */
public class WebSocketClientActor extends UntypedAbstractActor {
	...
	public WebSocketClientActor() throws URISyntaxException, IOException, DeploymentException, jakarta.websocket.DeploymentException {
		this.webSocketClientEndpoint = new WebSocketClientEndpoint(new URI(getWebSocketURI()));
